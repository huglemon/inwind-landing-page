			...
			<section className='flex flex-col gap-y-10 mb-32'>
				...
				>
					<div className='flex flex-col md:flex-row items-stretch justify-between gap-10'>
						<div className='w-full md:w-3/5 relative rounded-3xl overflow-hidden shadow-xl'>
							<Image
								src={'/img/about-left-1.png'}
								layout='fill'
								objectFit='cover'
								className='hover:scale-105 transition-all'
							/>
						</div>
						<div className='w-full md:w-2/5 ring-2 ring-base-content/10 py-5 px-10 rounded-3xl bg-base-200 shadow-xl'>
