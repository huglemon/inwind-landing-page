export const FAQList = {
  ...
  FAQ_FR: [
    {
      question: "Qu'est-ce qu'une page d'atterrissage ?",
      answer:
        "Une page d'atterrissage est une page web autonome créée spécifiquement pour une campagne marketing ou publicitaire. Les visiteurs 'atterrissent' sur cette page après avoir cliqué sur un lien dans un e-mail ou une publicité sur Google, Bing, YouTube, Facebook, Instagram, Twitter ou un emplacement similaire sur le web. Contrairement aux pages web qui ont généralement plusieurs objectifs et encouragent l'exploration, une page d'atterrissage est conçue avec un seul objectif ou focus, appelé appel à l'action (CTA).",
    },
    {
      question: "Comment créer une page d'atterrissage ?",
      answer:
        "La création d'une page d'atterrissage peut être réalisée en plusieurs étapes : 1) Choisissez un modèle de page d'atterrissage adapté aux besoins de votre campagne, ou commencez de zéro. 2) Définissez l'objectif de votre page d'atterrissage et votre CTA. 3) Rédigez un contenu attrayant qui incite les visiteurs à agir. 4) Ajoutez des éléments de design qui correspondent à votre message, comme des images, des vidéos et des formulaires. 5) Testez l'utilisabilité et la réactivité mobile de votre page. 6) Utilisez les meilleures pratiques SEO pour aider à la découverte de votre page. 7) Publiez votre page d'atterrissage et surveillez ses performances pour faire des ajustements si nécessaire.",
    },
    {
      question: "Pourquoi les pages d'atterrissage sont-elles importantes ?",
      answer:
        "Les pages d'atterrissage sont cruciales pour toute stratégie marketing car elles offrent une plateforme ciblée pour convertir les visiteurs en prospects ou clients. Contrairement aux sites web génériques, les pages d'atterrissage focalisent l'attention du visiteur sur une offre unique, minimisant les distractions et les guidant vers une action spécifique. Cette approche ciblée peut considérablement améliorer l'efficacité de vos campagnes marketing, améliorer les performances publicitaires et enrichir l'expérience utilisateur globale en leur fournissant les informations ou solutions qu'ils recherchent.",
    },
    {
      question: "Pourquoi choisir notre modèle de page d'atterrissage ?",
      answer:
        "Notre modèle de page d'atterrissage est gratuit, open source et puissant, parfait pour divers projets et campagnes marketing. Il vous permet de créer une page d'atterrissage en moins d'une heure, simplifiant le processus de développement tout en offrant un haut niveau de personnalisation et de réactivité.",
    },
    {
      question:
        "Quelles compétences sont nécessaires pour utiliser ce modèle ?",
      answer:
        "Pour utiliser notre modèle de page d'atterrissage, vous n'avez besoin que de compétences de base en édition web. Le modèle est conçu pour être facile à utiliser pour les utilisateurs non techniques, tout en offrant un haut niveau de personnalisation pour les développeurs expérimentés.",
    },
    {
      question:
        "Comment commencer à utiliser le modèle de page d'atterrissage ?",
      answer:
    ...
    {
      question:
        "Le modèle de page d'atterrissage supporte-t-il le design responsive ?",
      answer:
        "Oui, notre modèle de page d'atterrissage supporte le design responsive, assurant que votre page s'affiche parfaitement sur une variété d'appareils, qu'il s'agisse d'ordinateurs de bureau, de tablettes ou de smartphones.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Nous acceptons les services de développement personnalisé pour les pages d'atterrissage. Veuillez nous contacter par e-mail à karma.zhao@gmail.com ou sur Twitter @huglemon.",
    },
    {
      question: "Y a-t-il des restrictions à l'utilisation de ce modèle ?",
      answer:
        "Non. Vous êtes libre d'utiliser et de modifier ce modèle comme bon vous semble. En même temps, nous encourageons les développeurs à soumettre des PR pour aider à améliorer ce modèle de page d'atterrissage.",
    },
    {
